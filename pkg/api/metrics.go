...
func (r *requestResult) Increment(_ context.Context, code string, _ string, _ string) {
	metrics.KubernetesAPIRequest.WithLabelValues(code).Inc()
}

type requestLatency struct{}

func (r *requestLatency) Observe(_ context.Context, _ string, _ url.URL, latency time.Duration) {
